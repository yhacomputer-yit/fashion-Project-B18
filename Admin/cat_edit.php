                ...
                <nav class="sb-sidenav accordion text-black card" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link text-black" href="user_list.php">
                                <div class="sb-nav-link-icon"><i class="fa-solid fa-users"></i></div>
                                User Lists
                            </a>
                            <a class="nav-link text-black" href="category_list.php">
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <form action="" class="p-3 mt-5" method="post">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                <input type="text" disabled value="<?php echo $data['id']; ?>" name="cat_id" class="form-control" >
                                <input type="hidden" value="<?php echo $data['id']; ?>" name="cat_id" class="form-control" >
                                </div>
                            </div>
                            <div class="mb-3 row">
