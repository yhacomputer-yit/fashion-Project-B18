                    ...
                    <div class="container-fluid px-4">
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><a href="user_edit.php?id=<?php echo $data['id'] ?>" type="submit" class="btn btn-sm btn-outline-success">Edit</a>
                                        <a href="user_del.php?id=<?php echo $data['id'] ?>" type="submit" class="btn btn-sm btn-outline-danger">Delete</a>
                                    </td>
                                </tr>
