                    ...
                    <div class="container-fluid px-4">
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><a href="cat_edit.php?id=<?php echo $data['id'] ?>" type="submit" class="btn btn-sm btn-outline-success">Edit</a></td>
                                    <td><a href="cat_del.php?id=<?php echo $data['id'] ?>" type="submit" class="btn btn-sm btn-outline-danger">Delete</a></td>
                                </tr>
